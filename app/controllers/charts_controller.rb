class ChartsController < ApplicationController
  ...
  def index
    #données des series pour le graphique récapitulatif de chaque structure
    ...
    @series = @types_collects.map.with_index { |type_collects, index|
      @colors = ["#7cb5ec", "#434348", "#90ed7d", "#f7a35c", "#8085e9", "#f15c80", "#e4d354", "#2b908f", "#f45b5b", "#91e8e1", "#DB7F8E", "604D53", "#9DA3A4", "#FFC857", "#C5283D", "#255F85", "#481D24", "#44CFCB", "#4EA5D9", "#224870", "#122C34", "#F96900", "#7A4419", "#755C1B" ]
